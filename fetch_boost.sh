...
BOOST_FOLDERS=
for FOLDER in numeric/ublas serialization config mpl type_traits iterator tuple integer multi_index property_map concept smart_ptr optional archive dynamic_bitset parameter range bind python graph detail preprocessor utility exception unordered pending functional; do
