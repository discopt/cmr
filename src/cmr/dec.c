...
// }
//
// CMR_ERROR CMRdecCreate(CMR* cmr, CMR_MATROID_DEC* parent, size_t numRows, size_t* rowsParent, size_t numColumns,
//   size_t* columnsParent, CMR_MATROID_DEC** pdec)
// {
//   assert(cmr);
//
...
// }
//
// CMR_ERROR CMRdecTranslateMinorToParent(CMR_MATROID_DEC* node, CMR_MINOR* minor)
// {
//   assert(node);
//
//   if (minor)
...
// }
//
// CMR_ERROR CMRdecApplySeparation(CMR* cmr, CMR_MATROID_DEC* dec, CMR_SEPA* sepa)
// {
//   assert(cmr);
//   assert(dec);
//   assert(sepa);
...
// }
//
// CMR_ERROR CMRdecPrintSequenceNested3ConnectedMinors(CMR* cmr, CMR_MATROID_DEC* dec, FILE* stream)
// {
//   CMR_UNUSED(cmr);
//
//   assert(cmr);
...
// }
//
// char* CMRdecConsistency(CMR_MATROID_DEC* dec, bool recurse)
// {
//   if (!dec)
//     return NULL;
//
