...
CMR_ERROR TUtestTotalUnimodularityDbl(TU* tu, TU_DBLMAT* matrix, double epsilon, bool* pisTU, TU_DEC** pdec,
...
CMR_ERROR TUtestTotalUnimodularityInt(TU* tu, TU_INTMAT* matrix, bool* pisTU, TU_DEC** pdec, TU_SUBMAT** psubmatrix)
{
  assert(tu);
  assert(matrix);
...
CMR_ERROR TUtestTotalUnimodularityChr(TU* tu, TU_CHRMAT* matrix, bool* pisTU, TU_DEC** pdec, TU_SUBMAT** psubmatrix)
{
  assert(tu);
  assert(matrix);
