...
namespace tu {
  ...
  inline void matrix_set_value (matrix_permuted <MatrixType>& matrix, size_t row, size_t column,
  ...
  template <typename MatrixType>
  inline void matrix_set_value (matrix_permuted <const MatrixType>& matrix, size_t row, size_t column,
      typename MatrixType::value_type value)
  {
